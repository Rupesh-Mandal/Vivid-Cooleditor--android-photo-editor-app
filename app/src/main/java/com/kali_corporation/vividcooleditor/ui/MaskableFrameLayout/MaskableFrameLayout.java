package com.kali_corporation.vividcooleditor.ui.MaskableFrameLayout;
...
public class MaskableFrameLayout extends FrameLayout {
        ...
        if (theme != null) {
            ...
            try {
                ...
                mPorterDuffXferMode = getModeFromInteger(
                        a.getInteger(R.styleable.MaskableLayouts_porterduffxfermode, 0));
                initMask(mDrawableMask);
                //Check antiAlias
                if (a.getBoolean(R.styleable.MaskableLayouts_anti_aliasing, false)) {
    ...
    private Drawable loadMask(@NotNull TypedArray a) {
        return a.getDrawable(R.styleable.MaskableLayouts_mask);
    }
