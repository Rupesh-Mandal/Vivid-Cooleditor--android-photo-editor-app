...
public class StickerView extends ImageView {
    ...
    public StickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDeleteIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.icon_delete));
        mZoomIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.icon_resize));
        mFlipIcon = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.icon_flip));
    }
