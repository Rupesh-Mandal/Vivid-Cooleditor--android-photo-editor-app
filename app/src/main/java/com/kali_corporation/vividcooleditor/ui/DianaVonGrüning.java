...
import com.kali_corporation.vividcooleditor.tool.gui.GPUImage3x3ConvolutionFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImage3x3TextureSamplingFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageAddBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageAlphaBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageBilateralFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageBoxBlurFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageBrightnessFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageBulgeDistortionFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageCGAColorspaceFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageChromaKeyBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageColorBalanceFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageColorBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageColorBurnBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageColorDodgeBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageColorInvertFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageContrastFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageCrosshatchFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageDarkenBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageDifferenceBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageDilationFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageDirectionalSobelEdgeDetectionFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageDissolveBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageDivideBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageEmbossFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageExclusionBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageExposureFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageFalseColorFilter;
...
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageGammaFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageGaussianBlurFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageGlassSphereFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageGrayscaleFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageHalftoneFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageHardLightBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageHazeFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageHighlightShadowFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageHueBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageHueFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageKuwaharaFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageLaplacianFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageLevelsFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageLightenBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageLinearBurnBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageLookupFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageLuminosityBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageMonochromeFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageMultiplyBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageNonMaximumSuppressionFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageNormalBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageOpacityFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageOverlayBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImagePixelationFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImagePosterizeFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageRGBDilationFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageRGBFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSaturationBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSaturationFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageScreenBlendFilter;
...
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSketchFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSmoothToonFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSobelEdgeDetection;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSoftLightBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSourceOverBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSphereRefractionFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSubtractBlendFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageSwirlFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageToneCurveFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageToonFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageTransformFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageTwoInputFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageVignetteFilter;
import com.kali_corporation.vividcooleditor.tool.gui.GPUImageWeakPixelInclusionFilter;
...
//            Curve Filter
    ...
    public static GPUImageFilter createBlendFilter(Context context, Class<? extends GPUImageTwoInputFilter> filterClass) {
        try {
            ...
            filter.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launcher_foreground));
            return filter;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
