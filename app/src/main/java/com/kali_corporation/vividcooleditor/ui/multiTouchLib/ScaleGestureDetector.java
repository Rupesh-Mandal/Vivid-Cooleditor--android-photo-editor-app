package com.kali_corporation.vividcooleditor.ui.multiTouchLib;
...
public class ScaleGestureDetector {
    ...
    public boolean onTouchEvent(View view, MotionEvent event) {
        ...
        if (mInvalidGesture) {
            ...
            // Transform gesture in progress - attempt to handle com.it
            switch (action) {
                case MotionEvent.ACTION_POINTER_DOWN: {
    ...
    private int findNewActiveIndex(MotionEvent ev, int otherActiveId, int removedPointerIndex) {
        ...
        // It's ok if this isn't found and returns -1, com.it simply won't match.
