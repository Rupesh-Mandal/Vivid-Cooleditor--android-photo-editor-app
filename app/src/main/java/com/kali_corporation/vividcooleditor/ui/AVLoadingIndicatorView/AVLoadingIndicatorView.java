package com.kali_corporation.vividcooleditor.ui.AVLoadingIndicatorView;
...
import com.kali_corporation.vividcooleditor.ui.AVLoadingIndicatorView.Indicator.Indicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_minWidths, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_maxWidths, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_minHeights, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.AVLoadingIndicatorView_maxHeights, mMaxHeight);
        String indicatorName = a.getString(R.styleable.AVLoadingIndicatorView_indicatorNames);
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColors, Color.WHITE);
